...
public:
    ...
    Account(const string &username, const string &password, const FullName &name, const Gender &gender,
...
public:
    ...
    Staff(const string &username, const string &password, const FullName &name = {},
          const Gender &gender = Gender::Unknown) :
