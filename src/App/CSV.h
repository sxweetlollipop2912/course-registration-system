...
namespace CSVIO {
    ...
    public:
        CSVWriter();
        CSVWriter(int numberOfColumns);
        CSVWriter(const string &separator);
        CSVWriter(const string &separator, int numberOfColumns);
        ...
        bool writeToFile(const string &filename, bool append);
