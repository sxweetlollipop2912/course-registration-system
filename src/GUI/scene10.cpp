...
void scene10(sf::RenderWindow& window, App &_app) {
	...
	Textbox course_id("Course ID", 16, sf::Color::Black, sf::Vector2f(80, 100), sf::Vector2f(150, 50), sf::Color::White);
	course_id.set_outline(sf::Color::Black);

	Textbox course_name("Course Name", 16, sf::Color::Black, sf::Vector2f(230, 100), sf::Vector2f(400, 50), sf::Color::White);
	...
	scores.for_each([&](const auto& score) {
		...
		Textbox credits_cnt(std::to_string(course->credits), 16, sf::Color::Black, sf::Vector2f(630, 100 + num_row * 50),
			sf::Vector2f(100, 50), sf::Color::White);
		credits_cnt.set_outline(sf::Color::Black);


		Textbox midterm_score(double_to_string(score->midterm), 16, sf::Color::Black, sf::Vector2f(730, 100 + num_row * 50),
			sf::Vector2f(100, 50), sf::Color::White);
		...
		Textbox total_score(double_to_string(score->total), 16, sf::Color::Black, sf::Vector2f(1030, 100 + num_row * 50),
			sf::Vector2f(100, 50), sf::Color::White);
	...
	Textbox total_credit_box("Total credit: " + std::to_string(total_credit), 16, sf::Color::Black, sf::Vector2f(760, 60),
