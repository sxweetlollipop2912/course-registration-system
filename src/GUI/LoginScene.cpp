...
void login_scene(sf::RenderWindow& window)
{
    ...
    Input_Textbox usernameInputBox(usernameBox, sf::Color::Blue);
    usernameInputBox.set_lenth_limit(20);
    ...
    Input_Textbox passwordInputBox(passwordBox, sf::Color::Blue);
    passwordInputBox.set_lenth_limit(20);
