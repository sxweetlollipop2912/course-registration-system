...
void scene11(sf::RenderWindow& window, App &_app) {
	...
	Textbox course_id_header("Course ID", 16, sf::Color::Black, sf::Vector2f(0, 100), sf::Vector2f(100, 50), sf::Color::White);
	course_id_header.set_outline(sf::Color::Black);

	Textbox course_name_header("Course Name", 16, sf::Color::Black, sf::Vector2f(100, 100), sf::Vector2f(300, 50), sf::Color::White);
	course_name_header.set_outline(sf::Color::Black);

	Textbox credits_header("Credits", 16, sf::Color::Black, sf::Vector2f(400, 100), sf::Vector2f(100, 50), sf::Color::White);
	credits_header.set_outline(sf::Color::Black);

	Textbox sessions_header("Sessions", 16, sf::Color::Black, sf::Vector2f(500, 100), sf::Vector2f(200, 50), sf::Color::White);
	sessions_header.set_outline(sf::Color::Black);

	Textbox teacher_header("Teacher", 16, sf::Color::Black, sf::Vector2f(700, 100), sf::Vector2f(250, 50), sf::Color::White);
	...
	Textbox status_header("Status", 16, sf::Color::Black, sf::Vector2f(1050, 100), sf::Vector2f(150, 50), sf::Color::White);
	...
	while (window.isOpen() && app->scenes.top() == SceneType::Scene11) {
		...
		if (n > 0)
			...
			page_num_string = "0/0";
		Textbox page_num(page_num_string, 16, sf::Color::Black, sf::Vector2f(990, 60), sf::Vector2f(60, 40), sf::Color::White);
		...
		if (n > 0) {
			...
			pages[num_page].for_each([&](const auto& Iter) {
				...
				Textbox course_name(course->name, 16, sf::Color::Black, sf::Vector2f(100, current_y), sf::Vector2f(300, 100), sf::Color::White);
				...
				Textbox session1(Utils::sessionToStr(course->sessions[0].start) + "-" + Utils::sessionToStr(course->sessions[0].end).substr(4, 5),
					16, sf::Color::Black, sf::Vector2f(500, current_y), sf::Vector2f(200, 50), sf::Color::White);
				...
				Textbox session2(Utils::sessionToStr(course->sessions[1].start) + "-" + Utils::sessionToStr(course->sessions[1].end).substr(4, 5),
					16, sf::Color::Black, sf::Vector2f(500, current_y + 50), sf::Vector2f(200, 50), sf::Color::White);
				...
				Textbox slot(std::to_string(course->students.size()) + "/" + std::to_string(course->max_students),
					16, sf::Color::Black, sf::Vector2f(950, current_y), sf::Vector2f(100, 100), sf::Color::White);
				slot.set_outline(sf::Color::Black);
				textboxs.push_back(slot);


				if (enrollable) {
					Textbox status("", 16, sf::Color::Black, sf::Vector2f(1050, current_y), sf::Vector2f(150, 100), sf::Color::White);
