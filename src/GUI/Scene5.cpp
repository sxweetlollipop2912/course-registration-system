...
void scene5(sf::RenderWindow &_window, App &_app) {
    ...
    Textbox semester_box("Semester " + to_string(semester->no) + " (" + to_string(year->start_year) + " - " +
                         to_string(year->end_year) + ")",
                         GUI::defaultSmallCharSize,
                         sf::Color::Black,
    ...
    Textbox action_header("Action", GUI::defaultSmallCharSize, sf::Color::Black, sf::Vector2f(1050, current_y),
    ...
    if (n > 0) {
        pages[num_page].for_each([&](const DataIter &Iter) {
            ...
            Textbox credits(std::to_string(course->credits),
                            GUI::defaultSmallCharSize, sf::Color::Black, sf::Vector2f(400, current_y),
                            sf::Vector2f(100, 100), sf::Color::White);
            ...
            Textbox session1(Utils::sessionToStr(course->sessions[0].start) + " - " +
                             ...
                             GUI::defaultSmallCharSize, sf::Color::Black, sf::Vector2f(500, current_y),
                             sf::Vector2f(200, 50), sf::Color::White);
            ...
            Textbox teacher(course->teacher_name.last + " " + course->teacher_name.first,
                            ...
                            sf::Vector2f(250, 100), sf::Color::White);
            ...
            Textbox delete_text("Delete", GUI::defaultSmallCharSize, sf::Color::Black,
                                sf::Vector2f(1050 + 80, current_y), sf::Vector2f(70, 100), sf::Color::White);
