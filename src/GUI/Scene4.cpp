...
{
	Textbox studentBox("", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(0, 0), sf::Vector2f(350, 50), sf::Color::Transparent);
	Textbox studentIdBox("", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(0, 0), sf::Vector2f(150, 50), sf::Color::Transparent);
	studentBox.set_outline(sf::Color::Black);
	studentIdBox.set_outline(sf::Color::Black);

	
	Textbox nameTitleBox("Name", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(150, 100), sf::Vector2f(350, 50), sf::Color::Transparent);
	Textbox idTitleBox("Id", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(0, 100), sf::Vector2f(150, 50), sf::Color::Transparent);
	...
	cnt = 0;
	Textbox courseBox("", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(0, 0), sf::Vector2f(150, 50), sf::Color::Transparent);
...
static void view_score()
{
	...
	Textbox numPageBox(int_to_string(numPage) + "/" + int_to_string(totalPage), defaultMediumCharSize, sf::Color::Black, sf::Vector2f(1000, 40), sf::Vector2f(50, 50), sf::Color::Transparent);
...
void scene4(sf::RenderWindow& window, App& _app, DataIter &cl)
{
	...
	Textbox addStudentButton("Add a student", defaultMediumCharSize, sf::Color::Black, sf::Vector2f(windowWidth / 3 * 2 - 50, 100 + 75), sf::Vector2f(300, 50), sf::Color::Green);
